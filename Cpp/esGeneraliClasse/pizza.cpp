...
void caricaOrdine(pizza p[], ordine &o, int numPizze, int numPizzeOrd){
    ...
    o.costoBevanda = in_double("Inserisci costo bevanda", o.costoBevanda) ;
...
int main(int argc, char const *argv[])
{
    ...
    do{
        ...
        switch (s){
            ...
            case 4:
                m = mediaCosto(numPizze, pizze);
                cout << "Costo medio delle pizze del menu': " << m;
            break;
            ...
            case 8:
                ...
                tot = conto(pizze, ord1, numPizzeOrd);
                cout << "Il conto totale e': " << tot;
            break;
